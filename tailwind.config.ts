		...
		extend: {
			colors: {
				...
				energy: {
					...
					'orange-light': 'hsl(var(--energy-orange-light))',
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--energy-yellow) / 0.4)'
					},
					'50%': {
						boxShadow: '0 0 30px hsl(var(--energy-yellow) / 0.6)'
					}
				},
				'flow': {
